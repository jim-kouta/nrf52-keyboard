...
const uint8_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KEYMAP(
	...
	_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_HOME, KC_UP  , KC_PGUP,
	_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_NUBS, KC_TRNS, KC_LEFT, KC_TRNS,
  	_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_BSLS, _______, KC_END , KC_DOWN, KC_RGHT,
	_______, _______, _______, _______, _______,          _______,          _______, _______, KC_RCTL, KC_APP , _______, KC_INS , KC_DEL , KC_PGDN,
